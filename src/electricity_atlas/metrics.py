...
METRICS: tuple[dict[str, Any], ...] = (
    ...
    _metric("renewable_per_capita_mwh", "Erneuerbare pro Kopf", "Stromsystem", "MWh/Einwohner", monthly=False, yearly=True, source=f"{EMBER_SOURCE_LABEL}; {EUROSTAT_SOURCE_LABEL}", family="Erneuerbare gesamt", representation="Erzeugung in MWh je Einwohner", map_palette="renewables"),
    ...
    _metric("ev_battery_nominal_capacity_est_gwh", "Theoretische EV-Batteriekapazität", "Elektromobilität", "GWh", monthly=False, yearly=True, source=EUROSTAT_ROAD_SOURCE_LABEL, family="Batterieelektrische Pkw", representation="Bestand × 60 kWh; nicht V2G-verfügbar", map_palette="battery"),
