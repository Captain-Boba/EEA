    ...
    def test_missing_database_is_initialized_before_read_only_summary_api(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                self.assertIn('property="og:title" content="European Electricity Atlas"', html)
                self.assertIn('property="og:description" content="Europas Stromsysteme auf einen Blick.', html)
