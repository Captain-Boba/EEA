    ...
    def test_missing_database_is_initialized_before_read_only_summary_api(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                self.assertIn('href="/contact.html?lang=de"', html)
                self.assertIn('href="/privacy.html?lang=de"', html)
                self.assertIn('rel="help" href="/llms.txt"', html)
                self.assertIn('rel="service-desc" href="/openapi.json"', html)
                self.assertIn('href="/api.html?lang=de">API &amp; Datenzugriff</a>', html)
                ...
                self.assertIn('href="/api/compare?year=2025&amp;countries=DE%2CFR&amp;lang=de"', api_html)
